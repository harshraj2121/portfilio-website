    ...
    <>
      <div className='w-full h-[50vh] lg:h-[93.15vh] relative lg:grid lg:grid-cols-[1fr_2fr] lg:gap-7 lg:grid-flow-col bg-[#fca311]'>
        <div className='grid place-items-center h-full w-full'>
          <div style={{ boxShadow: 'rgb(38, 57, 77) 0px 20px 30px -10px' }} className='border-4 border-[#e5e5e5] z-20 w-[30vh] h-[30vh] md:w-[40vh] md:h-[40vh] xl:w-[45vh] xl:h-[45vh] bg-[url("https://plus.unsplash.com/premium_photo-1678197937465-bdbc4ed95815?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")] bg-cover lg:mb-28 rounded-full'></div>
        </div>

        <div className='h-fit lg:h-[93.15vh] w-full bg-slate-700 text-center text-white p-12 md:p-20 2xl:p-28'>
